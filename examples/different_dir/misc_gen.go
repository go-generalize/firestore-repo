...
type GetMultiErrors interface {
	Append(*GetMultiError)
	Len() int
	error
}
...
func NewGetMultiErrors() GetMultiErrors {
	return getMultiErrors(make([]*GetMultiError, 0))
}

var _ GetMultiErrors = (*getMultiErrors)(nil)

// Append - append get multi error
func (errs getMultiErrors) Append(err *GetMultiError) {
	errs = append(errs, err)
}

// Len - get multi errors length
func (errs getMultiErrors) Len() int {
	return len(errs)
}
